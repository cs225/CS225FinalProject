...
public class MaintenanceManagerGUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		classList.setModel(sessionListModel);
		...
		studentManagerPanel.add(classScrollPane,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 55, 150,
						120));
		...
		studentManagerPanel.add(studentScrollPane,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 55, 200,
						120));

		classScrollPaneLabel.setText("Class");
		studentManagerPanel.add(classScrollPaneLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, -1,
						-1));

		studentScrollPaneLabel.setText("Student");
		studentManagerPanel.add(studentScrollPaneLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 40, -1,
						-1));
		...
		studentManagerPanel.add(addClassButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 110, 90,
						-1));
		...
		studentManagerPanel.add(addStudentButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 150, -1,
						-1));

		jSeparator1.setOrientation(javax.swing.SwingConstants.VERTICAL);
		studentManagerPanel.add(jSeparator1,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(411, 0, 8,
						180));
		studentManagerPanel.add(jSeparator2,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 183, 1032,
						10));
		...
		studentManagerPanel.add(removeClassButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110,
						110, -1));
		...
		studentManagerPanel.add(removeStudentButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 150, -1,
						-1));
		...
		studentManagerPanel.add(removeAllButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 110, 97,
						66));

		jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);
		studentManagerPanel.add(jSeparator3,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 11,
						180));
		...
		studentManagerPanel.add(removalAreaLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 10, -1,
						-1));

		selectionArealabel.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
		selectionArealabel.setText("Selection");
		studentManagerPanel.add(selectionArealabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1,
						-1));

		addingAreaLabel.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
		addingAreaLabel.setText("Adding");
		studentManagerPanel.add(addingAreaLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 10, -1,
						-1));

		classControlJTable.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { null, null, null }, { null, null, null },
						{ null, null, null }, { null, null, null } },
				new String[] { "Student Name", "Average Score",
		...
		javax.swing.GroupLayout classControlPanelLayout = new javax.swing.GroupLayout(
				classControlPanel);
		classControlPanel.setLayout(classControlPanelLayout);
		classControlPanelLayout.setHorizontalGroup(classControlPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addComponent(classControlScrollPane,
						javax.swing.GroupLayout.DEFAULT_SIZE, 1025,
						Short.MAX_VALUE)
				.addGroup(
						classControlPanelLayout.createSequentialGroup()
								.addContainerGap()
								.addComponent(sortByNameButton)
								.addGap(18, 18, 18)
								.addComponent(sortByScoreButton)
								.addContainerGap()));
		classControlPanelLayout
				.setVerticalGroup(classControlPanelLayout
						.createParallelGroup(
						...
						.addGroup(
								classControlPanelLayout
										...
										.addGap(18, 18, 18)
										.addComponent(
												classControlScrollPane,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												320,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addContainerGap(94, Short.MAX_VALUE)));

		studentManagerControlTabbedPane.addTab("Class Control",
				classControlPanel);
		...
		studentControlPanel.add(studentControlScrollPane,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 1025,
						222));

		viewSelectedScenarioButton.setText("View Selected Scenario Input");
		viewSelectedScenarioButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						viewSelectedScenarioButtonActionPerformed(evt);
					}
				});
		studentControlPanel.add(viewSelectedScenarioButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 340,
						200, -1));

		studentNameLabel.setText("StudentName");
		studentControlPanel.add(studentNameLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(444, 0, -1,
						-1));

		printButton.setText("Print Selected Scenario Input");
		studentControlPanel.add(printButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 370,
						200, -1));

		SimulationScoreLabel.setText("AVG Simulation Score");
		studentControlPanel.add(SimulationScoreLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, -1,
						-1));
		...
		studentControlPanel.add(changePasswordButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 402, -1,
						-1));
		...
		studentControlPanel.add(changeUserNameButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 331, -1,
						-1));

		jSeparator6.setOrientation(javax.swing.SwingConstants.VERTICAL);
		studentControlPanel.add(jSeparator6,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(484, 258, 50,
						202));

		LoginModLabel.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
		LoginModLabel.setText("Login Modification");
		studentControlPanel.add(LoginModLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(684, 248, -1,
						-1));

		currentStudentUserNameLabel.setText("current Username");
		studentControlPanel.add(currentStudentUserNameLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(544, 311, -1,
						-1));

		currentStudentPasswordLabel.setText("current Password");
		studentControlPanel.add(currentStudentPasswordLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(544, 382, -1,
						-1));

		SimResultsAreaLabel.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
		SimResultsAreaLabel.setText("Simulation Results");
		studentControlPanel.add(SimResultsAreaLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 248, -1,
						-1));

		ViewScenarioSuggestionButton
				.setText("View Selected Scenario Suggestion");
		ViewScenarioSuggestionButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		studentControlPanel.add(ViewScenarioSuggestionButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 310, -1,
						-1));

		setScenarioScoreButton.setText("Set score for the Selected Scenario");
		setScenarioScoreButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
						setScenarioScoreButtonActionPerformed(evt);
					}
				});
		studentControlPanel.add(setScenarioScoreButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 310, -1,
						-1));

		studentManagerControlTabbedPane.addTab("Student Control",
				studentControlPanel);

		studentManagerPanel.add(studentManagerControlTabbedPane,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 1030,
						490));
		...
		changeProffessorUsernameButton
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
		...
		javax.swing.GroupLayout professorLoginManagerLayout = new javax.swing.GroupLayout(
				professorLoginManager);
		professorLoginManager.setLayout(professorLoginManagerLayout);
		professorLoginManagerLayout
				.setHorizontalGroup(professorLoginManagerLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								professorLoginManagerLayout
										...
										.addGroup(
												professorLoginManagerLayout
														.createParallelGroup(
																javax.swing.GroupLayout.Alignment.LEADING)
														.addComponent(
																currentProfessorUserNameLabel)
														.addComponent(
																currentProfessorPasswordLabel))
										.addContainerGap(789, Short.MAX_VALUE)));
		professorLoginManagerLayout
				.setVerticalGroup(professorLoginManagerLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								professorLoginManagerLayout
		...
		scenarioManagerPanel.add(scenarioScrollPanel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 30, 160,
						76));

		selectScenarioLabel.setText("Select Scenario to edit");
		scenarioManagerPanel.add(selectScenarioLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 12, -1,
						-1));

		jSeparator4.setPreferredSize(new java.awt.Dimension(0, 10));
		scenarioManagerPanel.add(jSeparator4,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 120, 1030,
						10));

		medJTable.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] { { "Insulin", "10 units", null, "10AM,3PM" },
						{ "Morphine", "50 milligrams", null, null },
						{ "Cocaine", "1 gram", null, null } }, new String[] {
		...
		javax.swing.GroupLayout marPanelLayout = new javax.swing.GroupLayout(
				marPanel);
		marPanel.setLayout(marPanelLayout);
		marPanelLayout
				.setHorizontalGroup(marPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								marPanelLayout
										...
										.addContainerGap(
												...
												Short.MAX_VALUE)));
		marPanelLayout
				.setVerticalGroup(marPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								marPanelLayout
		...
		javax.swing.GroupLayout documentationPanelLayout = new javax.swing.GroupLayout(
				documentationPanel);
		documentationPanel.setLayout(documentationPanelLayout);
		documentationPanelLayout
				.setHorizontalGroup(documentationPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								documentationPanelLayout
										...
										.addContainerGap()));
		documentationPanelLayout
				.setVerticalGroup(documentationPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								documentationPanelLayout
		...
		javax.swing.GroupLayout scenarioSummaryPanelLayout = new javax.swing.GroupLayout(
				scenarioSummaryPanel);
		scenarioSummaryPanel.setLayout(scenarioSummaryPanelLayout);
		scenarioSummaryPanelLayout
				.setHorizontalGroup(scenarioSummaryPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								scenarioSummaryPanelLayout
		...
		scenarioSummaryPanelLayout
				.setVerticalGroup(scenarioSummaryPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								scenarioSummaryPanelLayout
		...
		scenarioManagerPanel.add(previewTabbedPane,
		...
		scenarioManagerPanel.add(saveChangesButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 626, -1,
						-1));

		scenarioPreviewLabel.setText("Scenario Preview");
		scenarioManagerPanel.add(scenarioPreviewLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 120, -1,
						-1));
		...
		scenarioManagerPanel.add(UndoAllChangesButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(117, 626, -1,
						-1));

		jSeparator5.setOrientation(javax.swing.SwingConstants.VERTICAL);
		scenarioManagerPanel.add(jSeparator5,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 0, 10,
						120));
		...
		scenarioManagerPanel.add(addScenarioButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 40, -1,
						-1));
		...
		scenarioManagerPanel.add(removeScenarioButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 40, -1,
						-1));

		jSeparator7.setOrientation(javax.swing.SwingConstants.VERTICAL);
		scenarioManagerPanel.add(jSeparator7,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 40,
						120));
		...
		scenarioManagerPanel.add(importExportAreaLabel,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, -1,
						-1));
		...
		scenarioManagerPanel.add(importScenarioButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 50, 100,
						60));
		...
		scenarioManagerPanel.add(exportScenarioButton,
				new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 50, 110,
						60));
	...
	private void saveChangesButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (selectedScenarioName != null) {
			...
			// tenplates for setters when recording/editing a scenario.
			scenario.setAge(WIDTH);
			scenario.setAllergies(selectedScenarioName);
			scenario.setDescription(selectedScenarioName);
	...
	private void removeStudentButtonActionPerformed(
		...
		// removing the selected student from simcon list needs to be
		// handled.
	}
	...
	private void addStudentButtonActionPerformed(java.awt.event.ActionEvent evt) {
		...
		controller.addStudent(studentName, studentPW, className);
	...
	private void removeClassButtonActionPerformed(ActionEvent evt) {
		...
		// class name needs to be removed in simCon list
	}
